...
export default function DashboardClient() {
  const { 
    transactions, bills, savings, meters, orders, debts, 
    selectedMonth, selectedYear, exchangeRates,
    aiDashboardAdvice, lastAiFingerprint, setAiDashboardAdvice,
    aiWeeklyBriefing, aiUtilityAnomalies, aiMeta,
    fetchAiWeeklyBriefing, fetchAiUtilityAnomalies
  } = useAppStore();
  ...
  useEffect(() => {
    ...
    const fetchAiAdvice = async () => {
      ...
      try {
        ...
        if (aiWeeklyBriefing?.headline) {
          setAiDashboardAdvice(aiWeeklyBriefing.headline, currentFingerprint);
        } else {
