...
export const authClient = {
  ...
  register: (data: Omit<UserProfile, 'id' | 'role' | 'permissions' | 'household' | 'firstName' | 'lastName'> & { password?: string; password_confirmation?: string; first_name?: string; last_name?: string; firstName?: string; lastName?: string; invite_code?: string }) => 
