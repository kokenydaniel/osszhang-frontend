export const help = {
  ...
  budget: {
    ...
    categorySummary:
      'Kategóriánkénti tényleges költés: normál kiadásnál csak kifizetett tételek; saját keretnél (ledger) a felhasznált összeg, nem a teljes keret.',
    yearExpense: 'Az adott évben ténylegesen kifizetett kiadások összege (tételek, rezsi, tartozás-részletek).',
    yearIncome: 'Az adott évben befolyt bevételek összege.',
    yearNet: 'Éves bevétel mínusz éves kifizetett kiadás.',
    yearComparison: 'Összehasonlítás az előző év azonos időszakával (kifizetett kiadások alapján).',
    yearCategory: 'Kategóriánkénti kifizetett kiadás — az előző év ugyanazon kategóriájához viszonyítva.',
    yearTopCategory: 'A legnagyobb összegű kiadási kategória az évben.',
    yearInsights: 'Automatikus éves mutatók — átlag, csúcs hónap, megtakarítási arány, rezsi súly.',
    yearAi: 'AI éves összefoglaló a kifizetett tételek és kategóriák alapján — konkrét tanácsokkal.',
    yearIncomeSources: 'Befolyt bevételek kategóriánként — pl. Fizetés, Rezsi elszámolás.',
    yearMissedIncome: 'Lejárt, még nem befolyt bevételek összesítve az év hónapjaira bontva.',
    yearDebts: 'A költségvetésbe szinkronizált havi törlesztések — mi lett kifizetve az évben vs. aktuális hátralék.',
    yearSavings: 'Megtakarítási számlák ledger mozgásai: befizetés, kivét, és becsült egyenleg az év végén.',
    yearLedger:
      'Saját keretes kiadások (ledger) bontása: a keret neve alatt hol költöttél (pl. Lidl, Kifli.hu) az év ledger tételei alapján.',
    ...
    expenseLedger:
      'Előre lekötött keret (pl. tankolás): a tétel összege a plafon. A tényleges költést ledger bejegyzésekkel követed. Fizetendő = keret mínusz felhasználva; kifizetettként jelölve a ledger összeg számít „már kifizetve” és kategória összegzésnek.',
    incomeNormal:
