...
function SelectGroup({
  ...
  return (
    <SelectPrimitive.Group
      ...
      className={classNames("scroll-my-1 p-1", className)}
      {...props}
    />
  )
}
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={classNames("px-1.5 py-1 text-xs text-muted-foreground", className)}
      {...props}
    />
  )
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={classNames("pointer-events-none -mx-1 my-1 h-px bg-border", className)}
      {...props}
    />
  )
}
